...
class Media {
  ...
  onResize({ screen, viewport } = {}) {
    ...
    this.scale = this.screen.height / 720 // Aumentar el factor de escala un 25% respecto al anterior
    // Forzar tamaño grande fijo para las imágenes
    this.plane.scale.y = 6;
    this.plane.scale.x = 8;
...
export default function CircularGallery({
  ...
  return (
    <div className='w-full h-[500px] overflow-hidden cursor-grab active:cursor-grabbing' ref={containerRef} />
  )
}
